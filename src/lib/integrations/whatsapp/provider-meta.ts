...
export const WHATSAPP_INTEGRATION_META = {
  name: "WhatsApp",
  description:
    "Bestehendes WhatsApp-Profil verknüpfen und Chats in Cura verwalten.",
} as const;

export const WHATSAPP_PROFILE_COPY = {
  title: "Persönliches WhatsApp",
  intro:
    "Verknüpfen Sie Ihr eigenes WhatsApp-Profil mit Cura. Das machen Sie nur in Ihrem Profil auf Ihrem Telefon — kein Administrator und keine Team-Einrichtung nötig.",
  notConnectedHint:
    "Nach der Verknüpfung erscheinen Ihre WhatsApp-Chats im Tab «Nachrichten».",
  connectedHint: "Ihr persönliches WhatsApp ist mit Cura verknüpft.",
  privacyNote:
  ...
  previewSteps: [
    ...
    "«Stattdessen mit Telefonnummer verknüpfen» wählen und den Cura-Code eingeben.",
...
export const WHATSAPP_ONBOARDING_COPY = {
  ...
  pairingCodeLabel: "Cura-Code",
  pairingConfirmLabel: "Cura-Code bestätigen",
  pairingConfirmHint:
  ...
  doneTitle: "WhatsApp ist mit Cura verbunden",
  doneBody:
